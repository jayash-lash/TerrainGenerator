...
{
    internal class CustomLitDetailGUI
    {
        ...
        public struct LitProperties
        {
            ...
            public MaterialProperty textureScale;
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                textureScale = BaseShaderGUI.FindProperty("_TextureScale", properties, false);
            }
        }
        ...
        public static void DoDetailArea(LitProperties properties, MaterialEditor materialEditor)
        {
            ...
            // draw texture scale
            materialEditor.ShaderProperty(properties.textureScale, "Texture Scale");
        }
